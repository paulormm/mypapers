...
% João: não se concordo em colocar todas as métricas que a Analizo calcula se não faz sentido para C
% Ou mudamos a frase para não falar de C ou tiramos métricas como DIT, NOC,...
...
% João: infinite loops? A gente não roda o programa para dar loop infinito. Eu colocaria syntax errors ou algo do tipo.
