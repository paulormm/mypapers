...
%
Although we recognize that using these proxies is a limitation, we did not find in previous works better proxies that could represent more faithfully the number of users and number of developers in a large sample of projects.
...
(Total) Number of Downloads             & 6    & 941,498,760.00   & 957,000.00 & 17,760,000.00 & 8.20 & 2.66 \\ \hline
...
%
% João: fiz essa mudança para quebrar a mesma estrutura de frase
...
several hundred members (288), and hundreds of millions of downloads (941,498,760).
