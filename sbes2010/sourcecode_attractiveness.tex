...
o conceito de atratividade em projetos de software livre foi desenvolvido como um construtor latente que se expressa empiricamente de tres formas: (a) um projeto de software livre deve trazer visitantes ao portal do projeto; (b) os administradores do projeto esperam que os visitantes facam o download do software, potencialmente se tornando usuarios e/ou desenvolvedores da aplicacao; e (c) o visitante-usuario do software pode se tornar membro do projeto, habilitando-se a contribuir para ele, ajudando assim os estrategistas a atingirem seus objetivos mais ambiciosos. Eh com o intuito de explicar e maximizar o numero de (1) visitas, (2) downloads e (3) membros que o estudo das causas de atratividade se justifica.

Santos Jr. e Pearson apresentaram uma serie de testes estatisticos onde projetos com diferentes caracteristicas tiveram seus indices de atratividade comparados, procurando indicativos de que estas caracteristicas poderiam influenciar atratividade. Entre essas caracteristicas estao a(s) licenca(s) sob a qual o software foi disponibilizado a comunidade (e.g., GPL ou BSD), o publico-alvo do projeto (e.g., desenvolvedores ou usuarios-finais), os estagios das versoes do software disponibilizadas no portal do projeto (e.g., beta ou producao), e o tipo do projeto (e.g., cientifico ou jogo), ver Figura 1 para detalhes do modelo teorico. Em suma, neste doutorado sanduiche, queremos inserir no modelo teorico de causa e efeito de atratividade os atributos do codigo-fonte como uma das caracteristicas dos projetos de software livre correlacionadas com a atratividade.

Na literatura, o significado de sucesso em projetos de software livre ja foi medido de diversas formas como: numero de downloads (Crowston et al. 2004; Krishnamurthy 2002; Stewart et al. 2006); habilidade de avancar nas fases de desenvolvimento (Crowston et al. 2002; Raja et al. 2006); ou ainda como a propria quantidade de membros de um projeto (Crowston et al. 2006; Koch 2004). Nos nao acreditamos que estas medidas representem sucesso de forma completa, mas sim uma das formas de ajudar a chegar ao sucesso (ou mante-lo). Entretanto, no contexto do software livre, com o codigo-fonte sendo considerado o principal artefatos do projeto, levantamos a hipotese de que os atributos do codigo-fonte podem influenciar na atratividade do projeto, pois determinadas caracteristicas do codigo-fonte podem levar a mais contribuicoes ao software, atraindo mais usuarios e membros.

Esse e um primeiro passo em nossa analise de milhares de projetos de software livre atraves da qual queremos investigar a tese de que a escrita de codigo-fonte com determinadas caracteristicas (e.g., baixo acoplamento e alto coesao) tambem leva a projetos de maior sucesso.
...
This Section presents a source code analysis tool under development by our 
...
%
Also, Section~\ref{sdcollection} presents the criteria used for sample and data collection. 
%
Finally, Section~\ref{variables} presents the multiple regression model defined 
to test our hypothesis (Section~\ref{hypotheses}).
...
%
Its architecture was designed to support source code parsing, for different languages, and to
...
%
In previous works, our groups analyzed the structural complexity of some Free
Software written in C.
%%Paulo = referenciar trabalhos do Terceiro/Christina
%
Moreover, there are several academic works that evaluate a Free Software projects
written in Java, for example, according to related work (Section~\ref{related}).
%
On the other hand, a lot of Free softwares are written in C. Thus, this
demand and our experience in to evaluate Free software written in C defined 
this criteria, since this is the first of our studies relating source code 
metrics and attractiveness.
...
regression analysis we perform later. That way, we can maintain consistency. 
%% Chris wrt what?
