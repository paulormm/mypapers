...
%ultrapassam a barreira inicial de formação de uma comunidade de usuários e 
%desenvolvedores. 
%%
%Nesse estudo, investigamos a existência de correlações entre um 
%conjunto de métricas de código-fonte e a atratividade dos projetos de
%software livre, que é a capacidade de atrair usuários e desenvolvedores. 
%Para verificar estes relacionamentos hipotetizados, analisamos 6.773 projetos de Software Livre 
%do SourceForge.net. 
%%
%Os resultados indicam que a atratividade do projeto está correlacionada com certas 
%métricas de código-fonte de forma significativa. 
%Isso significa que, independente dos interesses individuais, 
%os usuários e desenvolvedores parecem ser influenciados de alguma forma
%pelas características do código-fonte ao adotar e contribuir com um software. 
%%
%Dessa forma, os líderes de projetos devem monitorar certas métricas de código-fonte, que podem ser 
%calculadas de forma objetiva. Isto porque estas métricas apresentam uma influência positiva 
%nas chances de uma comunidade de contribuidores e usuários se formar em torno do projeto, aumentando a qualidade do software livre.
%\end{resumo} 
...
in November, 2009, from Sourceforge.net, one of the most popular open source projects
...
%
A number of these influencing factors are highly subjective, such as audience 
...
%
In this model, they suggested that the success of any project depends on
...
metrics may affect the project attractiveness.
