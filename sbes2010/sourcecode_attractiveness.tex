...
(i) typical origins (e.g., license type, intended audience, type of project,
...
\begin{figure*}[!t]
\centering
\includegraphics[scale=.4]{attractiveness}
...
%
Thereby, we can observe whether both may interact with each other to influence
one's perception of quality.
%
Therefore, according to the selection of metrics that provide information
on structural complexity and size, i.e., the source code attributes defined 
in scope of this study, we formulated three hypotheses:
