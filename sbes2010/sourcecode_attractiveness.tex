...
\author{
  Paulo Meirelles, Carlos Santos Jr., Fabio Kon
  \\
  \begin{affiliation}
...
Typical definitions for quality assessment, as described in the ISO 9126
standard \cite{ISO9126}, are difficult to apply to Free Software projects.
Free Software projects exhibit a varying number of voluntary
contributors and many of the definitions present in ISO 9126 are not
performed explicitly \cite{Michlmayr2005}.
%
...
%
In this work, we use the concept of module as a general term for
refering to the different types of building-blocks used in software
...
The NM, NPA, NPM, LCOM and CBO metrics were originally proposed as
metrics for the object-oriented paradigm in mind.  Nevertheless, if we
generalize the concepts of ``class'' and ``method'' to ``module'' and
``function'', respectively, we can also apply them to other programming
paradigms.
